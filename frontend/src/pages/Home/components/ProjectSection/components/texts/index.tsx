import { Title, Text, TextsContainer } from "./style";
...
export function Texts() {
  return (
    <TextsContainer>
      ...
      <Text>
        <p>
          O Guia Alimentar para a População Brasileira é de fácil acesso e está
          disponível para todos, mas alguns estudos revelam que o documento
          ainda é pouco conhecido pela população brasileira. Assim, foi
          desenvolvido o projeto de iniciação tecnológica, denominado
        ...
        <p>
          ...
          Guia Alimentar para uma alimentação adequada e saudável, e elenca uma
          pontuação que traz a um resultado para cada participante. A partir
          deste resultado, você, participante, é redirecionado para uma
        ...
        <p>
          ...
          corroborar com a autonomia e mudança de comportamentos relacionados à
